...
public abstract class GameWindow extends JFrame {
	...
	public String getClosePrompt() { return closePrompt; }
	
	private boolean isShuttingDown;
	public boolean getIsShuttingDown() { return isShuttingDown; }
	...
	boolean isFocused;
	public boolean getFocusedState() { return isFocused; }
	
	boolean exitPromptShown = false;
	public boolean isExitPromptShown() { return exitPromptShown; }
	...
	public GameWindow(int width, int height) {
		...
		this.addWindowListener(new GameWindowAdapter());
	...
	*/
	...
	public GameWindowInputHandler getWindowInputHandler() { return input; }
	
	private Buffer buf;
	protected Buffer getBuffer() { return buf; }
	public BufferedImage getScreenshot() { return buf.capture(); }
	public void saveScreenshot(String file) { buf.screenshot(file); }
	...
	private void init() throws Exception {
		...
		//fix the game window for those unfortunate enough to be using OS X
		if(LibInfo.getOSType() == LibInfo.OS_MACOSX){
	...
	public void start() throws Exception {
		...
		LibInfo.dbg("GameWindow.start(): returned from GameLoop()");
	}
	...
	protected boolean showExitPrompt() {
		...
		switch(JOptionPane.showOptionDialog(this,
			...
			case JOptionPane.NO_OPTION:
				...
				input.keyReleased(KeyEvent.VK_ESCAPE);
				break;
			case JOptionPane.CLOSED_OPTION:
				//user clicked X, treat the same as No
