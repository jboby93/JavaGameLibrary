...
public class UIProgressBar extends UIElement {
	...
	public double getPercentFilled() { return ((double)value / (double)max) * 100; }
	public void setPercentFilled(double value) { this.value = (int)((value / 100) * (double)this.max); }
	...
	public void draw(Buffer b) {
		...
		b.fillRect(fill, loc, new Dimension(
				(int)((double)width * ((double)this.value / (double)this.max)),
				height));
	} //end draw()
