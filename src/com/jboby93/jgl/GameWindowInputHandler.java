...
public class GameWindowInputHandler implements KeyListener, MouseListener, MouseMotionListener, MouseWheelListener {	
	...
	public GameWindowInputHandler(Component c, int insetLeft, int insetTop) {
		LibInfo.dbg("GameWindowInputHandler(): adding listeners for window events");
		c.addKeyListener(this);
		c.addMouseListener(this);
		c.addMouseMotionListener(this);
		
		LibInfo.dbg("GameWindowInputHandler(): insetLeft = " + insetLeft + "; insetTop = " + insetTop);
		insetX = insetLeft; insetY = insetTop;
		
		LibInfo.dbg("GameWindowInputHandler(): preparing state variables");
	...
	public boolean getMouseButton(int button) { return mouseButtons[button]; }
	...
	public void keyPressed(int keyCode) {
		if(keyCode > 0 && keyCode < 256) keys[keyCode] = true;
	}
