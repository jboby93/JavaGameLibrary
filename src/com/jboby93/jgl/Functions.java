...
public class Functions {
	...
	public static Image getPartOfImage(Image img, Rectangle bounds) {
		BufferedImage cropped = new BufferedImage(bounds.width, bounds.height, BufferedImage.TYPE_INT_RGB);
