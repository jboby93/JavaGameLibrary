...
public class Angle {
	...
	public static double convertDegreesToRadians(double deg) { return deg * (Math.PI / 180); }
	public static double convertRadiansToDegrees(double rad) { return rad * (180 / Math.PI); }
} //end class Angle
